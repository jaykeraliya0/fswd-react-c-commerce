...
export default function Header() {
  ...
  return (
    <>
      <div className="fixed lg:relative top-0 h-fit z-20 w-full">
            ...
            <>
                ...
                <div className="relative flex h-16 justify-between">
                  ...
                  <div className="hidden lg:relative lg:z-10 lg:ml-4 lg:flex lg:items-center">
                    {user ? (
                      ...
                      <Link
                        to="/login"
                        className="ml-4 px-4 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-gray-700"
                      >
                        Login
                      </Link>
                    )}
              ...
              >
                {!user ? (
                  <a
                    href="/login"
                    className="block w-full px-5 py-3 pl-8 font-medium hover:bg-gray-100 border-t"
                  >
                    Login
                  </a>
                ) : (
